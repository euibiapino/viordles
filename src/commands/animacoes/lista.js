...
module.exports = { name: 'animacoes', description: 'Lista as animacoes pendentes', usage: '!animacoes', async execute(message, args) { return executeListar(message, args, CONFIG); } };
