...
module.exports = { name: 'filmes', description: 'Lista os filmes pendentes', usage: '!filmes [pagina]', async execute(message, args) { return executeListar(message, args, CONFIG); } };
